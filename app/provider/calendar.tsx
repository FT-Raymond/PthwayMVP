...
import { ChevronLeft, ChevronRight, TrendingUp, Plus, X } from 'lucide-react-native'
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <View>
            ...
            {dayEarnings > 0 && (
              <Text style={styles.dayEarnings}>
                Earned · <Text style={styles.dayEarningsAmount}>£{dayEarnings.toFixed(0)}</Text>
              </Text>
            )}
          </View>
        ...
        {daySlots.length === 0 && dayAvail.length === 0 ? (
          <View style={styles.emptyBox}>
            <Text style={styles.emptyText}>No bookings or slots for this day.</Text>
...
function AddSlotForm({ defaultDate, userId, onClose, onDone }: {
  defaultDate: Date; userId: string | null
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 32, fontWeight: '700', letterSpacing: -0.8, marginBottom: 16 },
  ...
  actionBtn: { borderWidth: 1, borderColor: '#f0f0f0', borderRadius: 16, padding: 16, alignItems: 'center', flexDirection: 'row', justifyContent: 'center', gap: 8 },
